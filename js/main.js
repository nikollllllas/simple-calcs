...
function getDisplayNumber(number) {
  ...
  let integerDisplay = isNaN(integerDigits) ? "" : integerDigits.toLocaleString("pt-br", { maximumFractionDigits: 0 })
...
function updateDisplay() {
  ...
  previousOperandTextElement.textContent = operation != null ? `${getDisplayNumber(previousOperand)} ${operation}` : ""
}
